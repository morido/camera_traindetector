/*
   ...
   Purpose:
   Provide Functions used throughout the entire Server-Software
*/
...
/*
   ...
   Purpose:
   Check if the current plaform is suitable for this program
...
Function: ErrorInternal
   Purpose:
   Prints an Errormessage including timestamp (ISO 8601)
   ...
   Note:
   This function is not supposed to be called directly, but via the define <error>
